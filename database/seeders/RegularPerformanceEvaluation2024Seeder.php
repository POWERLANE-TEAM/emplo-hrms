    ...
    public function run(): void
    {
        ...
        foreach ($regularEmployees as $employee) {
            $regularPerformance = RegularPerformance::create([
                ...
                'evaluator_signed_at' => Carbon::create(2024, 1, 2, 0, 0, 0),
                'secondary_approver_signed_at' => Carbon::create(2024, 1, 3, 0, 0, 0),
                'secondary_approver' => Employee::inRandomOrder()->first()->employee_id,
                'third_approver_signed_at' => Carbon::create(2024, 1, 4, 0, 0, 0),
                'third_approver' => Employee::inRandomOrder()->first()->employee_id,
                'fourth_approver_signed_at' => Carbon::create(2024, 1, 5, 0, 0, 0),
