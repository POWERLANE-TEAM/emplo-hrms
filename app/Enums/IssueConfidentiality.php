...
enum IssueConfidentiality: int
{
    ...
    {
        return match ($this) {
            self::ANONOYMOUS => __('The complaint can be submitted without disclosing your/the complainant’s identity, ensuring privacy while addressing the issue.'),
