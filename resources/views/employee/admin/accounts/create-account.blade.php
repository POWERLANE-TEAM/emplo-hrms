...
--}}
    ...
    <section class="mx-2">
        <form>
            ...
            <section>
                ...
                <div class="row">
                    <div class="col">
                        <x-form.boxed-email id="email" label="Email Address" name="email" autocomplete="email"
                            :nonce="$nonce" class=" {{ $errors->has('email') ? 'is-invalid' : '' }}" :required="true"
                            placeholder="">
                ...
                <div class="row">
                    <div class="col">
                        <x-form.boxed-input-text id="present_address" label="Present Address" name="present_address"
                            :nonce="$nonce" :required="true" placeholder="" />
                    </div>
                    <div class="col">
                        <x-form.boxed-input-text id="perm_address" label="Permanent Address" name="perm_address"
                            :nonce="$nonce" :required="true" placeholder="" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <x-form.boxed-dropdown id="sex" label="Sex at birth" name="sex" :nonce="$nonce"
                    ...
                    <div class="col">
                        <x-form.boxed-dropdown id="civil_status" label="Civil Status" name="civil_status" :nonce="$nonce"
                            :required="true" :options="[
                                'single' => 'Single',
                                'married' => 'Married',
                                'widowed' => 'Widowed',
                    ...
                    <div class="col">
                        <x-form.boxed-dropdown id="educ_attain" label="Educational attainment" name="educ_attain"
                            :nonce="$nonce" :required="true" :options="[
                                'none' => 'None',
            ...
            <section>
                ...
                <div class="row">
                    <div class="col">
                        <x-form.boxed-dropdown id="dept" label="Department" name="dept" :nonce="$nonce"
                            :required="true" :options="[
                                    // Add here the list
                                ]" placeholder="Select type">
                        </x-form.boxed-dropdown>
                    ...
                    <div class="col">
                        <x-form.boxed-dropdown id="job_position" label="Job Position" name="job_position" :nonce="$nonce"
                            :required="true" :options="[
                                    // Add here the list
                                ]" placeholder="Select type">
                        </x-form.boxed-dropdown>
                    ...
                    <div class="col">
                        <x-form.boxed-dropdown id="salary" label="Base Salary" name="salary" :nonce="$nonce"
                            :required="true" :options="[
                                    // Add here the list
                                ]" placeholder="Select type">
                        </x-form.boxed-dropdown>
                ...
                <div class="row">
                    <div class="col">
                        <x-form.boxed-dropdown id="role" label="Role" name="role" :nonce="$nonce"
                            :required="true" :options="[
                                    // Add here the list
                                ]" placeholder="Select type">
                        </x-form.boxed-dropdown>
                    ...
                    <div class="col">
                        <x-form.boxed-dropdown id="emp_status" label="Employment Status" name="emp_status"
                            :nonce="$nonce" :required="true" :options="[
                                    // Add here the list
                                ]" placeholder="Select type">
                        </x-form.boxed-dropdown>
                    ...
                    <div class="col">
                        <x-form.boxed-dropdown id="shift" label="Schedule / Shift" name="shift" :nonce="$nonce"
                            :required="true" :options="[
                                    // Add here the list
                                ]" placeholder="Select type">
                        </x-form.boxed-dropdown>
            ...
            <section>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <x-form.boxed-input-text id="philhealth_no" label="PhilHealth" name="philhealth_no"
                            :nonce="$nonce" :required="false" placeholder="" />
                    </div>
                </div>
    ...
    <x-buttons.main-btn id="create_acc" label="Create Account" name="create_acc" :nonce="$nonce" :disabled="false"
