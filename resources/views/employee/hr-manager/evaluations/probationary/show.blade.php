@extends('components.layout.employee.layout', ['description' => 'Probationary Performance Evaluation', 'nonce' => $nonce])
...
<livewire:hr-manager.evaluations.probationaries.performance-approvals 
    :$routePrefix 
    :$employee 
    :$yearPeriod 
/>
