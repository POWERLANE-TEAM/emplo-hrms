<div class="modal fade" id="addPerfRange" tabindex="-1" aria-labelledby="addPerfRangeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addPerfRangeModalLabel">Add Category</h1>
