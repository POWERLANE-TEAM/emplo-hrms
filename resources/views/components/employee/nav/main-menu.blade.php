    ...
    <x-employee.nav.sidebar sidebar_expanded="{{ $sidebar_expanded }}" class="" icon_size="{{ $icon_size }}"
        ...
        <x-employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Main" txt_expanded="Menu"
            ...
            <x-employee.nav.sidebar.nav-item href="/employee" :active="request()->is('employee')" class=""
                icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}" nav_txt="Dashboard" :default_icon="['src' => 'resources/images/icons/white-dashboard.webp', 'alt' => '']"
                :active_icon="['src' => 'resources/images/icons/green-dashboard.webp', 'alt' => '']">
            </x-employee.nav.sidebar.nav-item>

            <x-employee.nav.sidebar.nav-item href="/employees" :active="request()->is('employees')" class=""
                icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}" nav_txt="Employees" :default_icon="['src' => 'resources/images/icons/white-dashboard.webp', 'alt' => '']"
                :active_icon="['src' => 'resources/images/icons/green-dashboard.webp', 'alt' => '']">
            </x-employee.nav.sidebar.nav-item>

            <x-employee.nav.sidebar.nav-item href="#" :active="request()->is('#')" class=""
                icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}" nav_txt="Attendance"
                :default_icon="['src' => 'resources/images/icons/white-dashboard.webp', 'alt' => '']" :active_icon="['src' => 'resources/images/icons/green-dashboard.webp', 'alt' => '']">
            </x-employee.nav.sidebar.nav-item>

            <x-employee.nav.sidebar.nav-item href="#" :active="request()->is('#')" class=""
                icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}" nav_txt="Leaves" :default_icon="['src' => 'resources/images/icons/white-dashboard.webp', 'alt' => '']"
                :active_icon="['src' => 'resources/images/icons/green-dashboard.webp', 'alt' => '']">
            </x-employee.nav.sidebar.nav-item>

            <x-employee.nav.sidebar.nav-item href="#" :active="request()->is('#')" class=""
                icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}" nav_txt="Daily" :default_icon="['src' => 'resources/images/icons/white-dashboard.webp', 'alt' => '']"
                :active_icon="['src' => 'resources/images/icons/green-dashboard.webp', 'alt' => '']">
            </x-employee.nav.sidebar.nav-item>
            ...
            <x-employee.nav.sidebar.nav-item href="#" :active="request()->is('#')" class=""
                icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}" nav_txt="Clients" :default_icon="['src' => 'resources/images/icons/white-dashboard.webp', 'alt' => '']"
                :active_icon="['src' => 'resources/images/icons/green-dashboard.webp', 'alt' => '']">
            </x-employee.nav.sidebar.nav-item>
        ...
        <x-employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="AI Tools" txt_expanded=""
            icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}">
            <x-employee.nav.sidebar.nav-item href="#" :active="request()->is('#')" class=""
                icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}" nav_txt="Dashboard"
                :default_icon="['src' => 'resources/images/icons/white-dashboard.webp', 'alt' => '']" :active_icon="['src' => 'resources/images/icons/green-dashboard.webp', 'alt' => '']">
            </x-employee.nav.sidebar.nav-item>

            <x-employee.nav.sidebar.nav-item href="#" :active="request()->is('#')" class=""
                icon_size="{{ $icon_size }}" icon_ratio="{{ $icon_ratio }}" nav_txt="Employees"
                :default_icon="['src' => 'resources/images/icons/white-dashboard.webp', 'alt' => '']" :active_icon="['src' => 'resources/images/icons/green-dashboard.webp', 'alt' => '']">
            </x-employee.nav.sidebar.nav-item>
