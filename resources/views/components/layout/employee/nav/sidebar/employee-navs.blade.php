    ...
    <x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Main" txt_expanded="Menu">
        ...
        @canAny([UserPermission::VIEW_PAYSLIPS, UserPermission::VIEW_ALL_PAYSLIPS])
            <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($routePrefix . '.payslips')"
                class="tw-order-[{{ $nav_payslip_order }}]" nav_txt="Payslips" :default_icon="['src' => 'payslips', 'alt' => '']" :active_icon="['src' => 'payslips', 'alt' => '']">
            </x-layout.employee.nav.sidebar.nav-item>
        @endcan
        ...
        @canAny([UserPermission::VIEW_OVERTIME, UserPermission::VIEW_ALL_OVERTIME])
            <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($routePrefix . '.overtimes')" class="tw-order-[6]"
                nav_txt="Overtime" :default_icon="['src' => 'overtime', 'alt' => '']" :active_icon="['src' => 'overtime', 'alt' => '']">
            </x-layout.employee.nav.sidebar.nav-item>
        @endcan

        {{-- Employee, Supervisor --}}
        @canAny([UserPermission::VIEW_DOCUMENTS])
            <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($routePrefix . '.documents')" class="tw-order-[7]"
                nav_txt="Documents" :default_icon="['src' => 'documents', 'alt' => '']" :active_icon="['src' => 'documents', 'alt' => '']">
            </x-layout.employee.nav.sidebar.nav-item>
        @endcan
        ...
        @can(UserPermission::VIEW_ALL_APPLICANTS)
            <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($routePrefix . '.applicants')" class="tw-order-[2]"
        ...
        @can(UserPermission::VIEW_ALL_EMPLOYEES)
            <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($routePrefix . '.employees')" class="tw-order-[3]"
        ...
        @can(UserPermission::VIEW_ALL_RELATIONS)
            <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($routePrefix . '.relations')" class="tw-order-[11]"
                nav_txt="Relations" :default_icon="['src' => 'relations', 'alt' => '']" :active_icon="['src' => 'relations', 'alt' => '']">
            </x-layout.employee.nav.sidebar.nav-item>
        @endcan
        ...
        @can(UserPermission::VIEW_EMPLOYEE_MANAGER)
            <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.employees') }}" :active="request()->routeIs($routePrefix . '.employees')"
                class="" nav_txt="Employees" :default_icon="['src' => 'employee', 'alt' => '']" :active_icon="['src' => 'employee', 'alt' => '']">
            </x-layout.employee.nav.sidebar.nav-item>
        @endcan
        ...
        @can(UserPermission::VIEW_JOB_LISTING_MANAGER)
            <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.job-listing') }}" :active="request()->routeIs($routePrefix . '.jobboard')"
...
--}}
    ...
    <x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Config"
        ...
        @can(UserPermission::VIEW_PERFORMANCE_CONFIG)
            <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.performance') }}" :active="request()->routeIs($routePrefix . '.performance')"
        ...
        @can(UserPermission::VIEW_FORM_CONFIG)
            <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.form') }}" :active="request()->routeIs($routePrefix . '.form')"
        ...
        <x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="AI Tools"
            ...
            @can(UserPermission::VIEW_TALENT_EVALUATOR)
                <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->is('#')" class=""
                    nav_txt="Resume Evaluator" :default_icon="['src' => 'resume-evaluator', 'alt' => '']" :active_icon="['src' => 'resume-evaluator', 'alt' => '']">
            ...
            @can(UserPermission::VIEW_PLAN_GENERATOR)
                <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->is('#')" class=""
                    nav_txt="Plan Generator" :default_icon="['src' => 'plan-generator', 'alt' => '']" :active_icon="['src' => 'plan-generator', 'alt' => '']">
