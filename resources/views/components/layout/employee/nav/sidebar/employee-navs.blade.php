...
<x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Main" txt_expanded="Menu">
    ...
    @canAny([UserPermission::VIEW_EMPLOYEE_DASHBOARD, UserPermission::VIEW_HR_MANAGER_DASHBOARD,
        ...
        <x-layout.employee.nav.sidebar.nav-item 
            ...
            class="tw-order-[0]" 
            nav_txt="Dashboard" 
            :default_icon="['src' => 'dashboard', 'alt' => '']" 
    ...
    @canAny([UserPermission::VIEW_ATTENDANCE, UserPermission::VIEW_ALL_ATTENDANCE])
        <x-layout.employee.nav.sidebar.nav-item 
            href="#" 
            :active="request()->routeIs($routePrefix . '.attendances')"
            class="tw-order-[{{ $nav_attendance_order }}]" 
            nav_txt="Attendance" 
            :default_icon="['src' => 'attendance', 'alt' => '']" 
    ...
    @canAny([UserPermission::VIEW_PAYSLIPS, UserPermission::VIEW_ALL_PAYSLIPS])
        <x-layout.employee.nav.sidebar.nav-item 
            href="#" 
            :active="request()->routeIs($routePrefix . '.payslips')" 
            class="tw-order-[{{ $nav_payslip_order }}]"
            nav_txt="Payslips" 
            :default_icon="['src' => 'payslips', 'alt' => '']" 
    ...
    @canAny([UserPermission::VIEW_PERFORMANCE, UserPermission::VIEW_ALL_PERFORMANCE])
        <x-layout.employee.nav.sidebar.nav-item 
            href="#" 
            :active="request()->routeIs($routePrefix . '.performances')"
            class="tw-order-[{{ $nav_performance_order }}]" 
            nav_txt="Performance" 
            :default_icon="['src' => 'performances', 'alt' => '']" 
            :active_icon="['src' => 'performances', 'alt' => '']"
        >
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
    ...
    @can(UserPermission::VIEW_ISSUES)
        <x-layout.employee.nav.sidebar.nav-item 
            href="#" 
            :active="request()->routeIs($routePrefix . '.issues')" 
            class="tw-order-[8]" 
            nav_txt="Issues"
            :default_icon="['src' => 'issues', 'alt' => '']" 
            active_icon="['src' => 'issues', 'alt' => '']"
        >
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
    ...
    @can(UserPermission::VIEW_ALL_APPLICANTS)
        <x-layout.employee.nav.sidebar.nav-item 
            href="{{ route($routePrefix . '.applicants') }}" 
            :active="request()->routeIs($routePrefix . '.applicants')"
            class="tw-order-[2]" 
            nav_txt="Applicants" 
            :default_icon="['src' => 'applicants', 'alt' => '']" 
    ...
    @can(UserPermission::VIEW_ALL_RELATIONS)
        <x-layout.employee.nav.sidebar.nav-item 
            ...
            class="tw-order-[11]"
            nav_txt="Relations"
            :default_icon="['src' => 'relations', 'alt' => '']" 
    ...
    @can(UserPermission::VIEW_ACCOUNT_MANAGER)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.account.create') }}" 
            :active="request()->routeIs($routePrefix . '.account.create')"
            class="" 
            nav_txt="Accounts" 
    ...
    @can(UserPermission::VIEW_CALENDAR_MANAGER)
        <x-layout.employee.nav.sidebar.nav-item 
            ...
            class="" 
            nav_txt="Calendar" 
            :default_icon="['src' => 'calendar-manager', 'alt' => '']" 
            :active_icon="['src' => 'calendar', 'alt' => '']"
        >
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
    ...
    @can(UserPermission::VIEW_ANNOUNCEMENT_MANAGER)
        <x-layout.employee.nav.sidebar.nav-item 
            ...
            :default_icon="['src' => 'announcements', 'alt' => '']" 
            :active_icon="['src' => 'announcements', 'alt' => '']"
        >
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
...
<x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Config"
    ...
    @can(UserPermission::VIEW_FORM_CONFIG)
        <x-layout.employee.nav.sidebar.nav-item 
            ...
            class="" 
            nav_txt="Forms" 
            :default_icon="['src' => 'forms', 'alt' => '']" 
            :active_icon="['src' => 'forms', 'alt' => '']"
        >
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
