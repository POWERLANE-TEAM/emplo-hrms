...
<x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Main" txt_expanded="Menu">
    ...
    @can(UserPermission::VIEW_ALL_EMPLOYEES)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.index') }}" :active="request()->routeIs($routePrefix . '.index')"
            class="tw-order-[3]" nav_txt="Employees" :default_icon="['src' => 'employee', 'alt' => '']" :active_icon="['src' => 'employee', 'alt' => '']">
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
    ...
    @can(UserPermission::VIEW_ANNOUNCEMENT_MANAGER)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.announcement.create') }}"
            :active="request()->routeIs($routePrefix . '.announcement.create')" class="" nav_txt="Announcements" :default_icon="['src' => 'announcements', 'alt' => '']" :active_icon="['src' => 'announcements', 'alt' => '']">
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
...
<x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Config"
    ...
    @can(UserPermission::VIEW_PERFORMANCE_CONFIG)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.config.performance.categories') }}"
            :active="request()->routeIs($routePrefix . '.config.performance.*')" class="" nav_txt="Performance" :default_icon="['src' => 'performances', 'alt' => '']" :active_icon="['src' => 'performances', 'alt' => '']">
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
    ...
    @can(UserPermission::VIEW_FORM_CONFIG)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($routePrefix . '.config.form.pre-employment') }}"
            :active="request()->routeIs($routePrefix . '.config.form.*')" class="" nav_txt="Forms" :default_icon="['src' => 'forms', 'alt' => '']" :active_icon="['src' => 'forms', 'alt' => '']">
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
