...
<x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Main" txt_expanded="Menu">
    ...
    @canAny([UserPermission::VIEW_EMPLOYEE_DASHBOARD, UserPermission::VIEW_HR_MANAGER_DASHBOARD,
        ...
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($guard . '.dashboard') }}" :active="request()->routeIs($guard . '.dashboard')"
    ...
    @canAny([UserPermission::VIEW_ATTENDANCE, UserPermission::VIEW_ALL_ATTENDANCE])
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.attendances')"
    ...
    @canAny([UserPermission::VIEW_PAYSLIPS, UserPermission::VIEW_ALL_PAYSLIPS])
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.payslips')" class="tw-order-[{{ $nav_payslip_order }}]"
    ...
    @canAny([UserPermission::VIEW_PERFORMANCE, UserPermission::VIEW_ALL_PERFORMANCE])
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.performances')"
    ...
    @canAny([UserPermission::VIEW_LEAVES, UserPermission::VIEW_ALL_LEAVES])
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.leaves')" class="tw-order-[5]" nav_txt="Leaves"
    ...
    @canAny([UserPermission::VIEW_OVERTIME, UserPermission::VIEW_ALL_OVERTIME])
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.overtimes')" class="tw-order-[6]" nav_txt="Overtime"
    ...
    @canAny([UserPermission::VIEW_DOCUMENTS])
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.documents')" class="tw-order-[7]" nav_txt="Documents"
    ...
    @can(UserPermission::VIEW_ISSUES)
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.issues')" class="tw-order-[8]" nav_txt="Issues"
    ...
    @can(UserPermission::VIEW_ALL_APPLICANTS)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($guard . '.applicants') }}" :active="request()->routeIs($guard . '.applicants')"
    ...
    @can(UserPermission::VIEW_ALL_EMPLOYEES)
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.employees')" class="tw-order-[3]" nav_txt="Employees"
    ...
    @can(UserPermission::VIEW_ALL_RELATIONS)
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.relations')" class="tw-order-[11]" nav_txt="Relations"
    ...
    @can(UserPermission::VIEW_ACCOUNT_MANAGER)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($guard . '.create-account') }}" :active="request()->routeIs($guard . '.create-account')"
    ...
    @can(UserPermission::VIEW_CALENDAR_MANAGER)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($guard . '.calendar') }}" :active="request()->routeIs($guard . '.calendar-manager')" class=""
    ...
    @can(UserPermission::VIEW_JOB_LISTING_MANAGER)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($guard . '.job-listing') }}" :active="request()->routeIs($guard . '.jobboard')"
    ...
    @can(UserPermission::VIEW_ANNOUNCEMENT_MANAGER)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($guard . '.create-announcement') }}" :active="request()->routeIs($guard . '.create-announcement')"
            class="" nav_txt="Announcements" :default_icon="['src' => 'announcements', 'alt' => '']" :active_icon="['src' => 'announcements', 'alt' => '']">
        </x-layout.employee.nav.sidebar.nav-item>
    @endcan
...
<x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Config"
    ...
    @can(UserPermission::VIEW_PERFORMANCE_CONFIG)
        <x-layout.employee.nav.sidebar.nav-item href="{{ route($guard . '.performance') }}" :active="request()->routeIs($guard . '.performance')"
