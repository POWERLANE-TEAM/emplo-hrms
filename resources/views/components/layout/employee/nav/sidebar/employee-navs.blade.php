...
<x-layout.employee.nav.sidebar.nav-group :sidebar_expanded="$sidebar_expanded" class="" txt_collapsed="Main"
    ...
    <x-layout.employee.nav.sidebar.nav-item href="{{ route($guard . '.dashboard') }}"
        :active="request()->routeIs($guard . '.dashboard')" class="tw-order-[0]" nav_txt="Dashboard"
    ...
    <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.attendances')"
        class="tw-order-[{{ $nav_attendance_order }}]" nav_txt="Attendance"
    ...
    <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.performances')"
        class="tw-order-[{{ $nav_performance_order }}]" nav_txt="Performance"
    ...
    <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.leaves')" class="tw-order-[5]"
        nav_txt="Leaves" :default_icon="['src' => 'leaves', 'alt' => '']"
    ...
    @can(UserPermission::VIEW_ALL_APPLICANTS)
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.applicants')" class="tw-order-[2]"
            nav_txt="Applicants" :default_icon="['src' => 'applicants', 'alt' => '']"
    ...
    @can(UserPermission::VIEW_ALL_EMPLOYEES)
        <x-layout.employee.nav.sidebar.nav-item href="#" :active="request()->routeIs($guard . '.employees')" class="tw-order-[3]"
            nav_txt="Employees" :default_icon="['src' => 'employee', 'alt' => '']"
