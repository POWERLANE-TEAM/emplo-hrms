<picture>
    <source media="(min-width:2560px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/error/error-xl.webp') }}">
    {{-- 
    * |-------------------------------------------------------------------------- 
    ...
    * |-------------------------------------------------------------------------- 
    ...
    <source media="(min-width:1200px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/error/error-lg.webp') }}">

    <source media="(min-width:768px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/error/error-md.webp') }}">
    {{-- 
    * |-------------------------------------------------------------------------- 
    ...
    * |-------------------------------------------------------------------------- 
    ...
    <source media="(min-width:576px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/error/error-sm.webp') }}">
    {{-- 
    * |-------------------------------------------------------------------------- 
    ...
    * |-------------------------------------------------------------------------- 
    ...
    <source media="(min-width:320px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/error/error-xs.webp') }}">

    <img src="{{ Vite::asset('resources/images/illus/error/error-md.webp') }}" class="lg-illustration"
