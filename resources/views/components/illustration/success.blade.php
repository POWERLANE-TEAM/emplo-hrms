<picture>
    <source media="(min-width:2560px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/success/success-xl.webp') }}">
    {{-- 
    * |-------------------------------------------------------------------------- 
    ...
    * |-------------------------------------------------------------------------- 
    ...
    <source media="(min-width:1200px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/success/success-lg.webp') }}">

    <source media="(min-width:768px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/success/success-md.webp') }}">
    {{-- 
    * |-------------------------------------------------------------------------- 
    ...
    * |-------------------------------------------------------------------------- 
    ...
    <source media="(min-width:576px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/success/success-sm.webp') }}">
    {{-- 
    * |-------------------------------------------------------------------------- 
    ...
    * |-------------------------------------------------------------------------- 
    ...
    <source media="(min-width:320px)" class=""
        srcset="{{ Vite::asset('resources/images/illus/success/success-xs.webp') }}">

    <img src="{{ Vite::asset('resources/images/illus/success/success-md.webp') }}" class="lg-illustration"
